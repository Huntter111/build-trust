 ...
 */            (function(window, factory) {
    ...
    (() => {
        ...
        function showCustomContent(selectedValue) {
            ...
            for (let i = 0; i < contentElements.length; i++) contentElements[i].style.display = "none";
        ...
        document.addEventListener("selectCallback", (function(e) {
            ...
            if (mapContainer) showCustomContent(selectedValue);
        }));
        var mapContainer = document.querySelector(".map__container");
        if (mapContainer) showCustomContent(document.getElementById("custom_select").value);
            ...
            if (htmlElement.classList.contains("touch")) {
                ...
                if (menuOpenElement) {
                    ...
                    document.addEventListener("click", (function(event) {
                        ...
                        if (!isClickInside) menuOpenElement.classList.remove("sub-menu-open");
                    }));
                } else console.error("Елемент з ідентифікатором 'menuOpen' не знайдений.");
            }
        }));
        window["FLS"] = true;
        isWebp();
